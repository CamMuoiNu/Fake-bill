...
$description = "Uy Han - Trang chủ fake bill Vietinbank, Mbbank, Momo, vietcombank, v.v.v";
$keyword = "uyhan, ,uyhandev , fakengahang , hethongdev , hethongdev.store , arraycyber, sieuthird.site , gachcard1s.online ,hethongdev , gachcard1s , trang fakebill ,vanduy, fakebill minh duy, fakebill ngân hàng, minh duy fakebill, minhduy, website fake bill";
...
if ($changepages == 'fake-bill-vietinbank') {
    ...
    $description = "uyhandev - Trang fake bill VietinBank chuyển khoản miễn phí";
