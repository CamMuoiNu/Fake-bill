        ...
        <div class="container-xxl">
          <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
            <a href="./" class="app-brand-link gap-2">
              ...
              <span class="app-brand-text demo menu-text fw-bold">UyHanDev </span>
            </a>
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li class="nav-item dropdown-language dropdown me-1 me-xl-0">
                <a class="nav-link btn btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow" href="./" data-bs-toggle="dropdown">
                  <i onclick="window.location.href='https://uyhandev.com/';" class="mdi mdi-home mdi-24px"></i>
                </a>
              </li>
              <!--/ Language -->
              <!-- Style Switcher -->
               ...
               <li class="nav-item dropdown-style-switcher dropdown me-1 me-xl-0">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-styles">
                    <li>
                        <a class="dropdown-item waves-effect" href="https://uyhandev.com/">
          ...
          <aside id="layout-menu" class="layout-menu-horizontal menu-horizontal menu bg-menu-theme flex-grow-0">
            <div class="container-xxl d-flex h-100">
              <ul class="menu-inner">
                <!-- Dashboards -->
                <li class="menu-item">
                  <a href="https://uyhandev.com/" class="menu-link">
                    <i class="menu-icon tf-icons mdi mdi-home-outline"></i>
                    <div data-i18n="Home Page">Về Trang Chủ</div>
                  </a>
                </li>
