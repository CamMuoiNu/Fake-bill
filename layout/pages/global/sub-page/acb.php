<?php $options_header = ['title' => 'Tạo fake bill ACB Bank chuyển khoản','og:image'=> 'https://i.imgur.com/rSgRGCe.png'];?>
...
<?php require_once ($_SERVER['DOCUMENT_ROOT'] . '/include/nav.php'); ?> <div class="content-wrapper">
    ...
    <div class="flex-grow-1 container-p-y container-fluid">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            <span class="text-muted fw-light">Fake Bill Chuyển Khoản /</span> ACB Bank
        </h4>
        <div class="row">
            <div class="col-md-9">
                <form class="hk-acb hk-refresh-form">
                    <div class="card mb-4">
                        <h5 class="card-header">
                            <i class="ri-bank-fill me-2"></i>Tạo Bill ACB Bank
                        </h5>
                        <div class="card-body">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="thoigianchuyen" data-limit-text="27" class="form-label">Ngày Lập
                                    Lệnh</label>
                                <input type="text" class="form-control" name="thoigianchuyen"
                                    value="<?=date('d/m/Y H:i:s');?>" placeholder="Ví dụ: <?=date('d/m/Y H:i');?>"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="" data-limit-text="27" class="form-label">Ngày Hiệu Lực</label>
                                <input type="text" class="form-control" value="<?=date('d/m/Y');?>"
                                    placeholder="Ví dụ: <?=date('d/m/Y H:i');?>" disabled>
                            </div>
                            <!-- <div class="mb-3">
...
chuyen tien" required>NGUYEN VAN A chuyen tien</textarea>
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    <input type="hidden" name="action" value="fakebill-acb">
            ...
            <div class="col-md-3 d-none d-md-block">
                <div class="kq-bill text-center">
                    <img data-fancybox src="/<?=__IMG__?>/demo/acb.png" alt="Acb" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
