<?php $options_header = ['title' => 'Tạo fake số dư ví Momo miễn phí']?>
...
<div class="content-wrapper">
    ...
    <div class="flex-grow-1 container-p-y container-fluid">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            <span class="text-muted fw-light">Fake Số Dư /</span> Momo
        </h4>
        <div class="row">
            <div class="col-md-9">
                <form class="hk-sodu-momo hk-refresh-form">
                    <div class="card mb-4">
                        <h5 class="card-header">
                            <i class="ri-bank-fill me-2"></i>Tạo Số Dư Ví Momo
                        </h5>
                        <div class="card-body">
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    <input type="hidden" name="action" value="fakesodu-momo">
            ...
            <div class="col-md-3 d-none d-md-block">
                <div class="kq-bill text-center">
                    <img src="/<?=__IMG__?>/demo/momo-sodu.png" alt="Momo" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
