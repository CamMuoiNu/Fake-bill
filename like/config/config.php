...
session_start();
$base_url = 'https://uyhandev.com/like/'; // Thay url web bạn
class NMQ
{
    private $ketnoi;
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect('localhost', 'vvouyhansite_123321', 'vvouyhansite_123321', 'vvouyhansite_123321') or die ('Vui lòng kết nối đến DATABASE');
