<?php
    ...
    $title = 'QUẢN LÝ NGÂN HÀNG | '.$NMQ->site('tenweb');
...
if(isset($_POST['btnThemNganHang']) && $getUser['level'] == 'admin') 
{
    ...
    $isInsert = $NMQ->insert("bank", array(
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control show-tick" name="status_napbank" required>
                                        <option value="<?=$NMQ->site('status_napbank');?>">
                                            <?=$NMQ->site('status_napbank');?>
                                        </option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="stk_bank" value="<?=$NMQ->site('api_bank');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="api_bank" value="<?=$NMQ->site('api_bank');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>                           
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="api_momo" value="<?=$NMQ->site('api_momo');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>                           
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="noidung_naptien"
                                            value="<?=$NMQ->site('noidung_naptien');?>" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <textarea class="textarea" name="luuy_napbank"
                                            rows="6"><?=$NMQ->site('luuy_napbank');?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="ck_bank" placeholder="Khuyến mãi thêm bao nhiêu % khi nạp tiền qua ngân hàng, ví điện tử" value="<?=$NMQ->site('ck_bank');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table id="datatable" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    foreach($NMQ->get_list(" SELECT * FROM `bank` WHERE `id` IS NOT NULL ORDER BY id DESC ") as $row){
                                    ?>
                                    <tr>
                                        <td><?=$row['name'];?></td>
                        ...
                        <div class="table-responsive">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    foreach($NMQ->get_list(" SELECT * FROM `bank_auto` WHERE `username` IS NOT NULL ORDER BY id DESC ") as $row){
                                    ?>
                                    <tr>
                                        <td><?=$i++;?></td>
                                        <td><a href="<?=BASE_URL('Admin/User/Edit/'.$NMQ->getUser($row['username'])['id']);?>"><?=$row['username'];?></a></td>
                                        <td><?=$row['tid'];?></td>
                                        <td><?=$row['amount'];?></td>
                        ...
                        <div class="table-responsive">
                            <table id="datatable2" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    foreach($NMQ->get_list(" SELECT * FROM `momo` WHERE `username` IS NOT NULL ORDER BY id DESC ") as $row){
                                    ?>
                                    <tr>
                                        <td><?=$i++;?></td>
                                        <td><a href="<?=BASE_URL('Admin/User/Edit/'.$NMQ->getUser($row['username'])['id']);?>"><?=$row['username'];?></a></td>
