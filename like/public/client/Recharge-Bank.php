<?php
    ...
    $title = 'NẠP ATM/MOMO TỰ ĐỘNG| '.$NMQ->site('tenweb');
                    ...
                    <div class="p-2 border border-gray-300 mb-4">
                        <div class="flex justify-between items-center cursor-pointer">
                            <div class="flex select-none"><img src="<?=BASE_URL('assets/img/');?>bank.png"
                                ...
                                class="select-none focus:outline-none bg-blue-600 text-white text-xs inline-block h-5 flex items-center justify-center font-semibold px-2 rounded">
                                Auto
                            </button>
                        </div>
                        <div>
                            <div class="border-t border-gray-200 mt-2 p-2 select-text">
                                <div class="relative">
                                    <?=$NMQ->site('luuy_napbank');?>
                                    <p style="margin-left: 0px;">&nbsp;</p>
                                    <p>&nbsp;</p>
                                    <p><strong>THÔNG TIN TÀI KHOẢN NGÂN HÀNG</strong></p>
                                    <?php foreach($NMQ->get_list("SELECT * FROM `bank` ") as $bank) { ?>
                            ...
                            <div class="border-t border-gray-200 w-full select-text">
                                <div class="p-2">
                                    ...
                                    <div class="my-2 items-center w-full text-center"><span
                                            ...
                                            <b id="copyNoiDung"><?=$NMQ->site('noidung_naptien').$getUser['id'];?></b>
